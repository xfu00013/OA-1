		...
		<tbody>
			<tr height=35>
				...
				<td align=middle width=120 background=images/title_left.gif bgColor=#dee7ff>
					<font color=#f7f7f7> My Document Manage
		...
		<tbody>
			...
			<tr>
				<td height=14 align=right vAlign=center noWrap>
					<!-- 在这里插入查询表单 --> 
					【My Document】 
					<a href="approving_list.action">Approving Document</a> 
				...
				<td height=14 align="left" vAlign=center noWrap>
					<%
						 ...
						 */
					%> | 
					<a href="#" onclick="openWin('select_flow.action','selectFlow',600,200);">Add Document Info</a>
				</td>
			</tr>
			<tr>
				...
				<tr bgcolor="#EFF3F7" class="tablebody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
					...
					<td align="center" vAlign="center">
						<c:if test="${document.status eq 'New' }">
							...
							<a href="#" onclick="del('deleteDocument.action?id=${document.id}')">Delete</a>
						</c:if>
					</td>
				</tr>
			</c:forEach>
