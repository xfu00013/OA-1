...
<body bgColor=#dee7ff leftMargin=0 background="" topMargin=0 marginheight="0" marginwidth="0">
		...
		<tbody>
			<tr height=35>
				...
				<td align="center" width=120 background=images/title_left.gif bgColor=#dee7ff>
					<font color=#f7f7f7> Module Manage
		...
		<tbody>
			...
			<tr>
				...
				<td height=14 align="left" vAlign="middle" noWrap>
					<a href="#" onclick="openWin('module/add_input.jsp?parentId=${parentId}','addModule',600,200);">Add Module Info</a>
					<!-- 
					<a href="module.action?parentId=${ppid}">Back</a>
					-->
	...
	<table width="778" border="0" align=center cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
		...
		<tr bgcolor="#EFF3F7" class="tablebody1">
			...
			<td width="18%" height="37" align="center"><B>Module Name</B></td>
			<td width="18%" height="37" align="center"><b>Module Identifier</b></td>
			<td width="18%" height="37" align="center"><b>Father Module Name</b></td>
			...
			<c:forEach items="${pm.list }" var="module">
				<tr bgcolor="#EFF3F7" class="tablebody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
					...
					<td align="center" vAlign="middle">
						<a href="module.action?parentId=${module.id }">${module.name }</a>
					</td>
					...
					<td align="center" vAlign="middle">
						<a href="#" onclick="del('del_module.action?id=${module.id }');">Delete</a>
					</td>
				</tr>
			</c:forEach>
		</c:if>
		...
		<tbody>
			<tr>
				<td height=28 align=right vAlign="middle" noWrap background=images/list_middle.jpg>&nbsp;&nbsp; <!-- 可以在这里插入分页导航条 -->
					<pg:pager url="module.action" items="${pm.total }" export="currentPageNumber=pageNumber" maxPageItems="2" isOffset="true">
