...
<title>Distribute User Account</title>
</head>
<body>
	<center>
		...
		<form action="add_user.action" method="post">
			...
			<table class="tableEdit" border="0" cellspacing="1" cellpadding="0" style="width: 580px;">
				<tbody>
					<tr>
						<!-- 这里是添加、编辑界面的标题 -->
						<td align="center" class="tdEditTitle">Distribute User Account</td>
					</tr>
					<tr>
						<td>
							<!-- 主输入域开始 -->
			...
			<table>
				<tr align="center">
					<td colspan="3" bgcolor="#EFF3F7">
						<input type="submit" name="saveButton" class="MyButton" value="Save User Account"> 
